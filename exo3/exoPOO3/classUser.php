...
//          }else{
//             echo "<script>alert('Error during deletion');</script>";
//          }
        
//     }

//     public function deconnectUser($bdd,$id){
//         $connected=0;
    
//         $deconnect = $bdd->prepare("UPDATE users SET connected=? WHERE userId=?");
//         $execdeconnect = $deconnect->execute( [$connected,$id] );
